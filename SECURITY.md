...
The security of this Python File Audit tool is top priority!

Python File Audit is a tool designed to find security issues, so we do everything possible to make sure this tool itself is free of possible security issues.
...
To report a security issue, please use the GitHub Security Advisory ["Report a Vulnerability"](https://github.com/nocomplexity/fileaudit/security/advisories/new) tab.
