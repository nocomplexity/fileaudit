...
Python File Audit is a library designed to prevent security issues, so we do everything possible to make sure this module itself is free of possible security issues.
