...
Not a coder? Not a problem! **Python File Audit** is multifaceted, so I always can use help. 
...
The **File Audit** code repository is hosted at [Github](https://github.com/nocomplexity/fileaudit).

Simple Guidelines:

* Questions, Feature Requests, Bug Reports should all be reported on the [Github Issue Tracker](https://github.com/nocomplexity/fileaudit/issues) .
...
This fileaudit tool is designed by applying [Zero Complexity By Design principles](https://nocomplexity.com/documents/0complexity/abstract.html). So the goal is to keep the tool simple to use and the code simple to adjust or to extend.
...
:class: tip
Making code contributions to **Python File Audit** should be fun and simple!
...
As contributors, maintainers, administrators and founders of the Python fileaudit Community projects, and in the interest of fostering an open and welcoming community, we pledge to respect all people who contribute through reporting issues, posting feature requests, updating documentation, submitting pull requests or patches, and other activities.
