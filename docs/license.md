...
The **Python File Audit** library is licensed under the Mozilla Public License 2.0.
...
Copyright (c) 2026 BM-Support.org and Maikel Mardjan and all contributors.
...
**Python File Audit** is a Python program to perform a security audit on files before usage.

Copyright (C) 2026  BM-Support.org Foundation and Maikel Mardjan. 

This program is free software: you can redistribute it and/or modify
it under the terms of the [MPL-2.0 License](https://www.mozilla.org/en-US/MPL/2.0/).
